...
{
    public class PspsEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(PspsConfig config)
        {
            ...
            builder.RegisterInstance(config).As<PspsConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(PspsConfig config)
        {
            //register dependencies
