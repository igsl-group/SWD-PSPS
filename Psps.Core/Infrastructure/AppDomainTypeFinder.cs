...
{
    /// <summary>
    /// A class that finds types needed by Psps by looping assemblies in the
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <remarks>If you change this so that Psps assemblies arn't investigated (e.g. by not including something like "^Psps|..." you may break core functionality.</remarks>
        ...
        /// <summary>Gets or sets wether Psps should iterate assemblies in the app domain when loading Psps types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <returns>A list of assemblies that should be loaded by the Psps factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Psps.
        /// </returns>
