...
{
    public partial class OrgMasterSearchViewMap : BaseEntityMap<OrgMasterSearchView, int>
    {
        ...
        protected override void MapEntity()
        {
            ...
            Map(x => x.SimpChiOrgName).Column("SimpChiOrgName").Length(100);
            ...
            Map(x => x.EngRegisteredAddress1).Column("EngRegisteredAddress1").Length(200);
            ...
            Map(x => x.TelNum).Column("TelNum").Length(15);
            Map(x => x.FaxNum).Column("FaxNum").Length(15);
            ...
            Map(x => x.ApplicantTelNum).Column("ApplicantTelNum").Length(15);
            ...
            Map(x => x.ReceivedComplaintEnquiryBefore).Column("ReceivedComplaintEnquiryBefore");
            Map(x => x.PSPIssuedNum).Column("PSPIssuedNum");
            Map(x => x.FDPermitIssuedNum).Column("FDPermitIssuedNum");
            Map(x => x.SSAFPermitIssuedNum).Column("SSAFPermitIssuedNum");
            Map(x => x.ComplaintReceivedNum).Column("ComplaintReceivedNum");
